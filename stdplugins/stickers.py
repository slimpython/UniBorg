...
async def _(event):
    ...
    packname = f"Aniket's Sticker Pack"
    packshortname = f"Aniketpilantu"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Aniket's Animated Sticker pack"
        packshortname = f"aniketanimated"  # format: Uni_Borg_userid
